...
result +='第<span id="q" class="h">' + datas[i]['year']+check(datas[i]['period']) + '</span>期<p id="sqsj" class="d">' + yuefen + " 星期" +weekArray[new Date(datas[i]['lotteryTime'].replace("年","-").replace("月","-").replace("日","")).getDay()] +'</p>';
result +='</div>';
result +='<div class="kj-hm kj-right">';
result +='<div style="float: left;width:13.5%;"><div class="' + hm_ys(datas[i]['numberList'][0]['number']) +'"><h2><span>' + datas[i]['numberList'][0]['number'] +'</span></h2></div><div class="sx"><span>' + datas[i]['numberList'][0]['shengXiao'] + '<h class="wx">/' + datas[i]['numberList'][0]['wuXing'] + '</h></span></div></div>';
result +='<div style="float: left;width:13.5%;"><div class="' + hm_ys(datas[i]['numberList'][1]['number']) +'"><h2><span>' + datas[i]['numberList'][1]['number'] +'</span></h2></div><div class="sx"><span>' + datas[i]['numberList'][1]['shengXiao'] + '<h class="wx">/' + datas[i]['numberList'][1]['wuXing'] + '</h></span></div></div>';
result +='<div style="float: left;width:13.5%;"><div class="' + hm_ys(datas[i]['numberList'][2]['number']) +'"><h2><span>' + datas[i]['numberList'][2]['number'] +'</span></h2></div><div class="sx"><span>' + datas[i]['numberList'][2]['shengXiao'] + '<h class="wx">/' + datas[i]['numberList'][2]['wuXing'] + '</h></span></div></div>';
result +='<div style="float: left;width:13.5%;"><div class="' + hm_ys(datas[i]['numberList'][3]['number']) +'"><h2><span>' + datas[i]['numberList'][3]['number'] +'</span></h2></div><div class="sx"><span>' + datas[i]['numberList'][3]['shengXiao'] + '<h class="wx">/' + datas[i]['numberList'][3]['wuXing'] + '</h></span></div></div>';
result +='<div style="float: left;width:13.5%;"><div class="' + hm_ys(datas[i]['numberList'][4]['number']) +'"><h2><span>' + datas[i]['numberList'][4]['number'] +'</span></h2></div><div class="sx"><span>' + datas[i]['numberList'][4]['shengXiao'] + '<h class="wx">/' + datas[i]['numberList'][4]['wuXing'] + '</h></span></div></div>';
result +='<div style="float: left;width:13.5%;"><div class="' + hm_ys(datas[i]['numberList'][5]['number']) +'"><h2><span>' + datas[i]['numberList'][5]['number'] +'</span></h2></div><div class="sx"><span>' + datas[i]['numberList'][5]['shengXiao'] + '<h class="wx">/' + datas[i]['numberList'][5]['wuXing'] + '</h></span></div></div>';
result +='<div style="float: left;margin-top: 28px;width:3.75%;font-size: 10px;text-align: center;">➕</div>';
result +='<div style="float: right;"><div class="' + hm_ys(datas[i]['numberList'][6]['number']) +'"><h2><span>' + datas[i]['numberList'][6]['number'] +'</span></h2></div><div class="sx"><span>' + datas[i]['numberList'][6]['shengXiao'] + '<h class="wx">/' + datas[i]['numberList'][6]['wuXing'] + '</h></span></div></div>';
result +='</div>';
result +='</div>';
result ='</div>';
        }
